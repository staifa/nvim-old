...
vim.keymap.set("n", "<C-j>", live_grep, {})
vim.keymap.set("n", "<C-c>", current_buffer_fuzzy_find, {})
vim.keymap.set("n", "<C-f>", git_files, {})
vim.keymap.set("n", "<leader>bb", buffers, {})
vim.keymap.set("n", "<C-h>", lsp_refs, {})
vim.keymap.set("n", "<C-s>", resume, {})
vim.keymap.set("n", "<leader>s", workspace_symbols, {})
